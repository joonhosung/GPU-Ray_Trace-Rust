...
| biplane_100_5_2 | 100 | 5 | 2 | DNF (~1025s/it) | DNF |
| biplane_1000_1_2 | 1000 | 1 | 2 | DNF (~1045s/it) | - |
| biplane_1000_2_8 | 1000 | 2 | 8 | 23499.1s | - |
| biplane_10000_1_2 | 10000 | 1 | 2 | DNF (~885s/it) | - |
...
1. Performance Optimization
   * Multi-architecture GPU Backend
     * Generic gpu backend that utilizes existing crates to help create compute shaders to run on different gpu architectures.
     ...
     * Alternatively, implementation will explore wgpu for cross-platform compatibility but will need to manually write the shaders [wgpu](https://github.com/gfx-rs/wgpu).
